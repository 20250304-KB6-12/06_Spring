...
public class WeatherController {
    ...
    public String weather(Model model,
        ...
        // Java -> 외부 HTTP 요청(REST 요청)을 위한 RestTemplate객체 생성
        RestTemplate restTemplate = new RestTemplate();

        // 주소?q=seoul&appid=b34344840ce0683706d22279c613e66a&lang=kr&units=metric
        // 위 형태의 URL 문자열 생성
        ...
        // API 호출 후 응답 받기(동기식, JSON -> WeatherDTO 변환)
